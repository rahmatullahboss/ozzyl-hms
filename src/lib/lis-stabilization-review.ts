export type LisStabilizationReviewInput = {
  machineId?: number | null;
  branchName?: string | null;
};

export type LisStabilizationGate = {
  id: string;
  title: string;
  status: 'must_pass' | 'monitor' | 'manual_review';
  evidence: string;
...
export type LisStabilizationSection = {
  id: string;
  title: string;
  purpose: string;
  gates: LisStabilizationGate[];
};

export function buildLisStabilizationReview(input: LisStabilizationReviewInput = {}): LisStabilizationSection[] {
...
export function summarizeLisStabilizationReview(sections: LisStabilizationSection[]) {
