/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: edc6f3fa4d38d3b90b8314bd04a80a6d)
// Runtime types generated with workerd@1.20260518.1 2026-02-17 nodejs_compat
interface __BaseEnv_Env {
	...
	AI?: Ai;
	ASSETS: Fetcher;
	ENVIRONMENT: "staging" | "production" | "local_server" | "development";
	ALLOWED_ORIGINS: "https://hms-saas-staging.rahmatullahzisan.workers.dev" | "https://hms-saas-production.rahmatullahzisan.workers.dev,https://hms.ozzyl.com,https://app.ozzyl.com,https://admin.ozzyl.com,https://*.ozzyl.com,https://ozzyl-hms.pages.dev" | "http://localhost:8787,http://127.0.0.1:8787,http://hms.local:8787" | "http://localhost:5174,http://localhost:5173";
	EMAIL_PROVIDER: "brevo" | "stub";
	BREVO_FROM_EMAIL: "HMS Staging <noreply@hms-staging.app>" | "HMS <noreply@yourhospital.com>" | "HMS Local <noreply@hms.local>" | "HMS Dev <dev@hms.local>";
	RESEND_FROM_EMAIL: "HMS Staging <noreply@hms-staging.app>" | "HMS <noreply@yourhospital.com>" | "HMS Local <noreply@hms.local>" | "HMS Dev <dev@hms.local>";
	PATIENT_PORTAL_URL: "https://hms-saas-staging.rahmatullahzisan.workers.dev/patient-portal" | "https://hms-saas-production.rahmatullahzisan.workers.dev/patient-portal" | "http://hms.local:8787/patient" | "http://localhost:5173/patient-portal";
	HMS_APP_URL: "https://stage.ozzyl.com" | "https://hms.ozzyl.com" | "http://hms.local:8787";
	SMS_PROVIDER: "stub";
	PATIENT_AI_MODEL: "@cf/moonshotai/kimi-k2.5" | "disabled-local-server";
	PATIENT_AI_FALLBACK_MODEL: "glm-5.1:cloud" | "disabled-local-server";
	JWT_SECRET: string;
	CLOUDFLARE_ACCOUNT_ID: string;
	CLOUDFLARE_DATABASE_ID: string;
	GOOGLE_CLIENT_ID: string;
	DASHBOARD_DO?: DurableObjectNamespace<import("./src/index").DashboardDO>;
...
declare namespace Cloudflare {
	...
	interface ProductionEnv {
		...
		ALLOWED_ORIGINS: "https://hms-saas-production.rahmatullahzisan.workers.dev,https://hms.ozzyl.com,https://app.ozzyl.com,https://admin.ozzyl.com,https://*.ozzyl.com,https://ozzyl-hms.pages.dev";
		EMAIL_PROVIDER: "brevo";
		BREVO_FROM_EMAIL: "HMS <noreply@yourhospital.com>";
		RESEND_FROM_EMAIL: "HMS <noreply@yourhospital.com>";
		PATIENT_PORTAL_URL: "https://hms-saas-production.rahmatullahzisan.workers.dev/patient-portal";
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "ENVIRONMENT" | "ALLOWED_ORIGINS" | "EMAIL_PROVIDER" | "BREVO_FROM_EMAIL" | "RESEND_FROM_EMAIL" | "PATIENT_PORTAL_URL" | "HMS_APP_URL" | "SMS_PROVIDER" | "PATIENT_AI_MODEL" | "PATIENT_AI_FALLBACK_MODEL" | "JWT_SECRET" | "CLOUDFLARE_ACCOUNT_ID" | "CLOUDFLARE_DATABASE_ID" | "GOOGLE_CLIENT_ID" | "LOCAL_SERVER_ID">> {}
}
