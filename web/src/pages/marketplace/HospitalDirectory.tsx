      ...
      <div className="bg-white border-b border-gray-200 px-4 py-4">
        <div className="max-w-6xl mx-auto">
          <div className="flex items-center gap-2 text-sm text-gray-500 mb-3">
            ...
            <span>/</span>
            <span className="text-gray-900 font-medium">{t('marketing:directory.hospitals.title')}</span>
          </div>
          ...
          <form onSubmit={handleSearch} className="flex gap-2 max-w-xl">
            <input
              ...
              placeholder={t('marketing:directory.hospitals.searchPlaceholder')}
          ...
          <div className="flex-1">
            <div className="flex items-center justify-between mb-4">
              <p className="text-sm text-gray-500">
                {loading ? t('marketing:directory.hospitals.searching') : t('marketing:directory.hospitals.resultsCount', { count: total })}
              </p>
            ...
            {loading ? (
              ...
              <div className="text-center py-16 text-gray-400">
                ...
                <p className="font-medium">{t('marketing:directory.hospitals.noResults')}</p>
                <p className="text-sm mt-1">{t('marketing:directory.hospitals.adjustFilters')}</p>
              </div>
