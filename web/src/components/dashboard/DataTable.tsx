          ...
          <thead>
            <tr>
              {columns.map((col) => (
                ...
                >
                  <button
                    className="flex items-center gap-1 w-full font-inherit cursor-pointer hover:bg-[var(--color-border-light)] focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-[var(--color-primary)] p-2 -m-2 rounded"
        ...
        <div className="flex items-center justify-between px-4 py-3 border-t border-[var(--color-border)]">
          ...
          <div className="flex gap-1" role="navigation" aria-label="Pagination">
            <button
              ...
              className="p-2 rounded hover:bg-[var(--color-border-light)] disabled:opacity-50 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-[var(--color-primary)]"
            >
            ...
            {[...Array(Math.min(5, totalPages))].map((_, i) => {
              ...
              return (
                <button
                  ...
                  className={`px-3 py-1 rounded focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-[var(--color-primary)] ${currentPage === page ? 'bg-[var(--color-primary)] text-white' : 'hover:bg-[var(--color-border-light)]'}`}
                >
                  {page}
                </button>
              );
...
// Type assertion needed because memo loses generics.
export default memo(DataTableBase) as typeof DataTableBase;
