      ...
      return (
        <div style={styles.container}>
          <div style={styles.card}>
            ...
            <h1 style={styles.title}>{i18n.t('errorBoundary.title', { defaultValue: 'Something went wrong' })}</h1>
            <p style={styles.message}>
              {i18n.t('errorBoundary.message', { defaultValue: 'An unexpected error occurred. Please reload the page or try again.' })}
            </p>
            {this.state.error && (
              <details style={styles.details}>
                <summary style={styles.summary}>{i18n.t('errorBoundary.details', { defaultValue: 'Error details' })}</summary>
