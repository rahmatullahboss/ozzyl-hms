...
export default function SyncStatusBar() {
  const { isOnline, pendingCount, isSyncing, lastSyncAt, syncNow } =
    useOffline();
    ...
    >
      ...
      {isOnline && pendingCount > 0 && !isSyncing && (
        <button
          ...
          className="ml-1 rounded underline underline-offset-2 hover:opacity-80 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-[var(--color-primary)]"
          aria-label="Sync now"
        >
          Sync now
        </button>
