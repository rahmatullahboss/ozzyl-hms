...
export { printRunningBill, buildRunningBillHtml, getRunningBillPreviewWidth } from './runningBillTemplate';
...
export type { RunningBillData, RunningBillPaperSize } from './runningBillTemplate';
