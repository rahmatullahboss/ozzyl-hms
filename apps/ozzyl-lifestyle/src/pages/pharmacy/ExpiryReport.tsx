      ...
      <div className="space-y-5 max-w-screen-xl mx-auto">
        ...
        <div className="card p-4">
          <div className="flex flex-wrap gap-3 items-end">
            <div>
              <label className="form-label">{t('pharmacy.showExpiringWithin')}</label>
            ...
            <div className="flex-1 min-w-36">
              <label className="form-label">{t("pharmacy.searchItem")}</label>
              <input className="form-control" placeholder={t("pharmacy.searchItemOrBatch")}
